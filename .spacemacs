...
before packages are loaded."
  ...
  ;; Don't warn me in advance, just on the day
  (setq org-deadline-warning-days 0)
  ;; Don't carry over missed scheduled
  ;; (setq org-scheduled-past-days nil)
  ;; Don't show scheduled in todo list
  ...
  ;; M-x org-cliplink M-x org-mode
  ;; C-x p l
  (global-set-key (kbd "C-x p l") 'org-cliplink)
  ...
  ;; completion in src blocks for ipython
